...
export const ITINERARY_DATA: DaySchedule[] = [
    ...
    items: [
      {
        ...
        description: 'Otele 5 dk yürüme mesafesinde. Bagel ve sandviçleri çok meşhur.',
      ...
      },
      {
        id: 'd1-shopping',
        time: '15:30',
        title: 'Calle Sierpes & Calle Tetuán (Alışveriş & İndirimler)',
        description: 'Zara, Mango, Pull&Bear gibi markaların kalbi. İspanya\'ya gelmişken Inditex grubuna uğramadan olmaz.',
        location: 'Calle Sierpes',
        type: ActivityType.SHOPPING,
        tips: [
          'Fiyatlar Türkiye ve Avrupa\'ya göre daha uygundur.',
          'Ale-Hop: İnek logolu mağaza. Hediyelik ve ıvır zıvır için çok ucuzdur.'
        ]
      },
      {
        id: 'd1-xmas-belen',
    ...
    items: [
      {
        ...
        price: '~14.50€ - 15€',
        type: ActivityType.SIGHTSEEING,
        tips: ['Kesinlikle Online al, kapıda kalma riski var!', 'Gezmesi en az 2-3 saat sürer.']
      },
      {
        id: 'd2-santacruz',
        time: '12:30',
      ...
      },
      {
        ...
        description: 'Çarşamba günleri menüdeki neredeyse her şey (sandviçler, içecekler) 1€. 10€-15€\'ya masayı donatırsın.',
      ...
      },
      {
        ...
        description: 'Sadece dans odaklı profesyonel şov. Çıkışta Bodega Palo Santo\'da "Boğa Kuyruğu" veya "Kızartma Ahtapot" yiyebilirsin.',
        location: 'Teatro Flamenco Sevilla',
        price: '20€ (Kapı) / 25€ (Online)',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Madrid\'in en meşhur caddesi. Otelinin önünden başlar.',
        location: 'Gran Vía',
        type: ActivityType.SIGHTSEEING
      },
      {
        ...
        description: 'Şehrin kalbi. "Ayı ve Kocayemiş Ağacı" heykeli ile fotoğraf çekil.',
      ...
      },
      {
        ...
        description: 'Plaza de España\'da kurulan dev Noel pazarı ve buz pisti tam otelinin kapısında.',
        location: 'Plaza de España',
        type: ActivityType.CHRISTMAS_MARKET
      },
      {
  ...
  },
  {
    id: 'day4',
    date: '19 Aralık Cuma',
    title: 'Madrid: Outlet Alışverişi ve Saraylar',
    items: [
      {
        id: 'd4-palace',
        time: '09:30',
        title: 'Palacio Real (Kraliyet Sarayı)',
        description: 'Oteline çok yakın. Dışarıdan görmek bile yeterli.',
      ...
      {
        id: 'd4-shopping-outlet',
        time: '13:00',
        title: 'SEÇENEK 1: Las Rozas Village (Lüks Outlet)',
        description: 'Markaların (Gucci, Prada, Adidas, Nike vb.) %60\'a varan indirimli olduğu açık hava outlet köyü.',
        location: 'Las Rozas Village',
        type: ActivityType.SHOPPING,
        tips: [
          'Ulaşım: Moncloa otobüs durağından (Oteline yakın) 625, 628 veya 629 numaralı otobüslerle 30-40 dk.',
          'Madrid\'in en ünlü outleti burasıdır.'
        ]
      },
      {
        id: 'd4-shopping-city',
        time: '13:00',
        title: 'SEÇENEK 2: Şehir İçi Ucuzluk',
        description: 'Uzaklaşmak istemezsen şehir içindeki seçenekler.',
        location: 'Gran Vía',
        type: ActivityType.SHOPPING,
        tips: [
      ...
      },
      {
        ...
        description: 'Gran Vía yakınlarında, önünde hep sıra olan çok ucuz Meksikacı.',
